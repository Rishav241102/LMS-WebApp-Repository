  ...
  return (
    ...
    px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>
        Build the skills employers want with expert-led courses, hands-on projects,
        and smart progress tracking—everything you need to learn faster and achieve more.
      </p>

      <p className='md:hidden text-gray-500 max-w-sm mx-auto'>
        Learn new skills with industry-ready courses, hands-on projects, and mentors who care.
      </p>
      <SearchBar/>
